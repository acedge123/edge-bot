---
name: tool-design
description: "Reference library (context engineering): This skill should be used when the user asks to \"design agent tools\", \"create tool descriptions\", \"reduce tool complexity\", \"implement MCP tools\", or mentions tool consolidation, architectural reduction, tool naming conventions, or agent-tool interfaces. Trigger only when the user explicitly asks about context engineering / context windows / memory systems / multi-agent architecture / agent evaluation, or mentions this skill by name (tool-design)."
---
