...
description: "Reference library (context engineering): This skill should be used when the user asks to \"understand context\", \"explain context windows\", \"design agent architecture\", \"debug context issues\", \"optimize context usage\", or discusses context components, attention mechanics, progressive disclosure, or context budgeting. Provides foundational understanding of context engineering for AI agent systems. Trigger only when the user explicitly asks about context engineering / context windows / memory systems / multi-agent architecture / agent evaluation, or mentions this skill by name (context-fundamentals)."
---
