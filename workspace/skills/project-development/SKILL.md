...
description: "Reference library (context engineering): This skill should be used when the user asks to \"start an LLM project\", \"design batch pipeline\", \"evaluate task-model fit\", \"structure agent project\", or mentions pipeline architecture, agent-assisted development, cost estimation, or choosing between LLM and traditional approaches. Trigger only when the user explicitly asks about context engineering / context windows / memory systems / multi-agent architecture / agent evaluation, or mentions this skill by name (project-development)."
---
