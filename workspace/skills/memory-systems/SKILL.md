...
name: memory-systems
description: >-
  Reference library (context engineering): Trigger only when the user explicitly
  asks about context engineering / context windows / memory systems / multi-agent
  architecture / agent evaluation, or mentions this skill by name (memory-systems).
