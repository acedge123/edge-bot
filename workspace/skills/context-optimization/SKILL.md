...
description: "Reference library (context engineering): This skill should be used when the user asks to \"optimize context\", \"reduce token costs\", \"improve context efficiency\", \"implement KV-cache optimization\", \"partition context\", or mentions context limits, observation masking, context budgeting, or extending effective context capacity. Trigger only when the user explicitly asks about context engineering / context windows / memory systems / multi-agent architecture / agent evaluation, or mentions this skill by name (context-optimization)."
---
