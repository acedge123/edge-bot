...
description: "Reference library (context engineering): This skill should be used when the user asks to \"diagnose context problems\", \"fix lost-in-middle issues\", \"debug agent failures\", \"understand context poisoning\", or mentions context degradation, attention patterns, context clash, context confusion, or agent performance degradation. Provides patterns for recognizing and mitigating context failures. Trigger only when the user explicitly asks about context engineering / context windows / memory systems / multi-agent architecture / agent evaluation, or mentions this skill by name (context-degradation)."
---
